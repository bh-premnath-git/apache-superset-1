...
CREATE TABLE IF NOT EXISTS household.hh_master (
    ...
    "State_label" varchar(50) NULL,
    "Survey_Code_label" varchar(50) NULL,
    "Reason_for_Substitution_Code_label" varchar(50) NULL,
    ...
    "Engaged_in_Economic_Activity_Las_label" varchar(50) NULL,
    "Max_Income_Activity_label" varchar(50) NULL,
    "Self_Employment_Source_Sector_label" varchar(50) NULL,
    "Regular_Wage_Source_Sector_label" varchar(50) NULL,
    "Casual_Labour_Source_Sector_label" varchar(50) NULL,
    "Religion_of_HH_Head_label" varchar(50) NULL,
    "Social_Group_of_HH_Head_label" varchar(50) NULL,
    "Land_Ownership_label" varchar(50) NULL,
    "Type_of_Land_Owned_label" varchar(50) NULL,
    "Dwelling_Unit_Exists_label" varchar(50) NULL,
    "Type_of_Dwelling_Unit_label" varchar(50) NULL,
    "Energy_Source_Cooking_label" varchar(50) NULL,
    "Energy_Source_Lighting_label" varchar(64) NULL,
    "Ration_Card_Type_label" varchar(64) NULL,
    "Rent_Rate_Available_Rural_label" varchar(50) NULL,
    "Benefitted_From_PMGKY_label" varchar(50) NULL,
    ...
    "Ration_Any_Item_Last_30_Days_label" varchar(50) NULL,
    "Ceremony_Performed_Last_30_Days_label" varchar(50) NULL,
    beverages_qty_total int4 NULL,
    cereal_qty_total float4 NULL,
    dairy_qty_total int4 NULL,
    "edible oil_qty_total" float4 NULL,
    pulses_qty_total float4 NULL,
    spices_qty_total int4 NULL,
    suger_salt_qty_total float4 NULL,
    vegetables_qty_total int4 NULL,
    egg_fish_meat_qty_total int4 NULL,
    "fresh fruits_qty_total" int4 NULL,
    "dry fruits_qty_total" float4 NULL,
    "cereal substitute_qty_total" int4 NULL,
    beverages_val_total int4 NULL,
    cereal_val_total int4 NULL,
    dairy_val_total int4 NULL,
    "edible oil_val_total" int4 NULL,
    pulses_val_total int4 NULL,
    spices_val_total int4 NULL,
    suger_salt_val_total int4 NULL,
    vegetables_val_total int4 NULL,
    egg_fish_meat_val_total int4 NULL,
    "fresh fruits_val_total" int4 NULL,
    "dry fruits_val_total" int4 NULL,
    "cereal substitute_val_total" int4 NULL,
    beverages_qty_out int4 NULL,
    cereal_qty_out float4 NULL,
    dairy_qty_out int4 NULL,
    "edible oil_qty_out" int4 NULL,
    pulses_qty_out int4 NULL,
    spices_qty_out int4 NULL,
    suger_salt_qty_out int4 NULL,
    vegetables_qty_out int4 NULL,
    egg_fish_meat_qty_out int4 NULL,
    "fresh fruits_qty_out" int4 NULL,
    "dry fruits_qty_out" int4 NULL,
    "cereal substitute_qty_out" int4 NULL,
    beverages_val_out int4 NULL,
    cereal_val_out int4 NULL,
    dairy_val_out int4 NULL,
    "edible oil_val_out" int4 NULL,
    pulses_val_out int4 NULL,
    spices_val_out int4 NULL,
    suger_salt_val_out int4 NULL,
    vegetables_val_out int4 NULL,
    egg_fish_meat_val_out int4 NULL,
    "fresh fruits_val_out" int4 NULL,
    "dry fruits_val_out" int4 NULL,
    "cereal substitute_val_out" int4 NULL,
    ...
    "Kerosene_ration_card_label" varchar(50) NULL,
    "LPG_subsidy_received_label" varchar(50) NULL,
    "Free_electricity_label" varchar(50) NULL,
    "Any_member_attended_school_label" varchar(50) NULL,
    "Fee_waiver_received_label" varchar(50) NULL,
    "Hospitalization_case_label" varchar(50) NULL,
    "Medical_benefit_received_label" varchar(50) NULL,
    electricity_val_total int4 NULL,
    firewood_val_total int4 NULL,
    "other fuel_val_total" int4 NULL,
    "subtotal fuel and light_val_total" int4 NULL,
    "LPG_val_total" int4 NULL,
    kerosene_other_val_total int4 NULL,
    "kerosene_PDS_val_total" int4 NULL,
    conveyance_val_total int4 NULL,
    "edu expense_val_total" int4 NULL,
    "house_garage rent_val_total" int4 NULL,
    "medical nonhospitalized_val_total" int4 NULL,
    "other HH consumables_val_total" int4 NULL,
    "other consumer services_val_total" int4 NULL,
    "toilet articles_val_total" int4 NULL,
    "medical hospitalized_val_total" int4 NULL,
    entertainment_val_total int4 NULL,
    "other consumer taxes_cesses_val_total" int4 NULL,
    "subtotal rent_val_total" int4 NULL,
    internet_val_total int4 NULL,
    taxi_val_total int4 NULL,
    airfare_val_total int4 NULL,
    ...
    "TV_Facility_Type_label" varchar(50) NULL,
    clothing_val_total int4 NULL,
    footwear_val_total int4 NULL,
    bedding_val_total int4 NULL,
    "HH appliances_val_total" int4 NULL,
    building_land_durable_val_total int4 NULL,
    crockery_utensil_val_total int4 NULL,
    furniture_fixture_val_total int4 NULL,
    jewelry_ornaments_val_total int4 NULL,
    "personal good_val_total" int4 NULL,
    "transport equipment_val_total" int4 NULL,
    recreation_val_total int4 NULL,
    "medical equipment_val_total" int4 NULL
);
