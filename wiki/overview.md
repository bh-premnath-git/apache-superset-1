...
### Dashboards
- `dashboard.household.survey` — Household dashboard with rural segments table and a state-filterable district-segment map

### Notable charts
- `chart.household.rural_segment_comparison` — Handlebars table comparing rural segments
- `chart.household.district_pie_unified` — Cartodiagram map with a per-district pie sub-chart, filterable by State.
